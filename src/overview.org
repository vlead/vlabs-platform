...
* Introduction
  ...
  Labs. Lab data service (LDS), content service, experiment service and translators
...
The output of this route is a packaged structure of the lab files required by
openedx
