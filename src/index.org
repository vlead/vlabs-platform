...
* Motivation
  ...
  a browser can interpret.  Apart from untethering the content creation from
  the hosting platform, the platform should be able to provide other services
  like single sign on, persistence, analytics and uniform user interface. 
