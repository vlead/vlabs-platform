...
* Motivation
  ...
  - learning management system (LMS) providing features that allow an
    instructor to manage the learning of the students by setting up a learning
...
:END:
  ...
  1. Untie authoring of content to delivery of content.  
     ...
     - Delivery of content, the content can be delivered either from 
       ...
       The advantage of using an existing MOOC platform is that the functions
       of single sign on, persistence, uniform UI are built into the platform.
       With a VLEAD delivery platform, these functions will have to be built.
